#ifndef HALIDE____root___hdr___plus___build_______genfiles___hdrplus_pipeline___hdrplus_pipeline_h
#define HALIDE____root___hdr___plus___build_______genfiles___hdrplus_pipeline___hdrplus_pipeline_h
#include <stdint.h>
