file(REMOVE_RECURSE "/root/temp/cmake-3.17.2/Tests/CMakeTests/uploads")

if(EXISTS "/root/temp/cmake-3.17.2/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/root/temp/cmake-3.17.2/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/root/temp/cmake-3.17.2/Tests/CMakeTests/uploads")

set(filename "/root/temp/cmake-3.17.2/Tests/CMakeTests/FileDownloadInput.png")
if(NOT "/root/temp/cmake-3.17.2/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}/root/temp/cmake-3.17.2/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/root/temp/cmake-3.17.2/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/root/temp/cmake-3.17.2/Tests/CMakeTests/uploads/file2.png"
